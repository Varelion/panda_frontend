...
function Home() {
  ...
  return (
    <div className="">
      ...
      <div id="home-body-grid" className=" !z-10 absolute top-[70px] min-h-[85vh] flex flex-row gap-5 m-4 justify-center items-center overflow-y-auto"
      >
...
{/* <MesmerizingCarousel  /> */}
    <div id='placeholder' className='bg-green-500 min-w-[100%] min-h-[100%]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi quas autem ducimus sint suscipit, quasi recusandae cumque aliquam illo consequuntur blanditiis, voluptatum culpa iure nulla veritatis illum? Ipsa, labore neque?</div>
        </div>
      </div>
 // TODO: Find out why this div under here isn't being rendered -- it's stuck behind < StarringBanner />
