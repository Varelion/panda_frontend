...
const CheatCodeBanner = React.memo(function CheatCodeBanner({
  ...
  return (
    <div
      className={`relative overflow-hidden ${className} mt-[-3rem] rounded-2xl right-50 `}
      style={{
        width,
...
export default CheatCodeBanner;
