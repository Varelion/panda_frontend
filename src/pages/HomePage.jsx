    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative z-10 pt-20">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row-reverse items-start justify-center gap-8 min-h-[calc(100vh-120px)]">
            {/* Text content column */}
            <div className="flex-1 max-w-2xl">
              <div className="bg-gradient-to-br from-red-50 via-white to-orange-50 backdrop-blur-sm rounded-lg p-6 shadow-xl border border-red-100">
                ...
                <div className="bg-white/70 rounded-lg p-6 mb-6 border border-red-200">
                  <p className="text-gray-700 text-lg leading-relaxed text-center mb-4">
                    Experience the <span className="font-bold text-red-600">authentic taste of Pandaria</span> with our 
                    fresh-wok cooking and time-honored recipes passed down through generations of Pandaren masters.
                  </p>
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                  <p className="text-center text-sm text-gray-600">
                    <strong className="text-red-600">Pandren Express</strong> is a <strong>fun parody project</strong> celebrating 
                    the <strong>Pandaren race</strong> from World of Warcraft, specially crafted for the 
                    <strong className="text-blue-600"> Moon Guard roleplay community</strong>. 
                    Not affiliated with Panda Express or Blizzard Entertainment.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full hover:from-red-600 hover:to-red-700 transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                    🥡 Start Your Order
                  </button>
                  <button
                    onClick={handleTryClick}
                    className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                    💬 Join Discord
                  </button>
                </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-red-200">
            ...
            <p className="text-gray-700 text-lg leading-relaxed text-center max-w-3xl mx-auto">
              From the <span className="font-bold text-red-600">Valley of the Four Winds</span> to your table - 
              experience the finest Pandaren culinary creations crafted with <span className="font-bold text-orange-600">ancient wisdom</span> and the 
              freshest ingredients. Our master chefs bring you a perfect harmony of <span className="font-bold text-red-600">traditional Pandaren flavors</span> 
              and modern wok techniques.
            </p>
